...
public class AlbumsUpdateScheduler {
    ...
    public AlbumsUpdateScheduler(AlbumsUpdater albumsUpdater, DataSource albumSchedulerDataSource) {
        this.albumsUpdater = albumsUpdater;
        this.jdbcTemplate = new JdbcTemplate(albumSchedulerDataSource);
    }
